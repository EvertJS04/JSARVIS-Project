...
char_window.config(bg="dark blue")
...
#            webbrowser.open("Https://www." + websearch_string)
    ...
    def use_user_input(event=None):
        ...
        user_input_response = Label(char_window, text=user_name + ": " + user_input, fg="black", bg="dark blue")
        user_input_response.pack()
        char_output_response = Label(char_window, text=formatted_response, fg="black", bg="dark blue")
    ...
    submit_button = Button(char_window, command=use_user_input, text="Submit",
                           font=("Helvetica", 16))
    submit_button.pack()
